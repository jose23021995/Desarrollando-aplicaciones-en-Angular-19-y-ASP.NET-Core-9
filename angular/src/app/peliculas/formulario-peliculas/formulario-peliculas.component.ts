...
@Component({
    ...
    imports: [MatFormFieldModule, ReactiveFormsModule, MatInputModule, MatButtonModule, RouterLink, MatDatepickerModule, InputImgComponent, SelectorMultiplesComponent, AutocompleteActoresComponent],
...
export class FormularioPeliculasComponent implements OnInit {
  ...
  guardarCambios(){
    ...
    console.log("pelicula",pelicula.actores);
  ...
  /*
  pruebaAsyc(){
   console.log("generosNoSeleccionados",this.generosNoSeleccionados);
   console.log("generosSeleccionados",this.generosSeleccionados);
   console.log("cinesNoSeleccionados",this.cinesNoSeleccionados);
   console.log("cinesSeleccionados",this.cinesSeleccionados);
   console.log("actoresSeleccionados",this.actoresSeleccionados);
  }
  */
}
